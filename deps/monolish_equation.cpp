...
void wrap_equation(Module &mod){
  ...
  mod.add_type<Parametric<TypeVar<1>, TypeVar<2>>>("none")
     .apply<monolish::equation::Jacobi<monolish::matrix::Dense<double>, double>>(WrapMonolishnone())
     .apply<monolish::equation::Jacobi<monolish::matrix::Dense<float>, float>>(WrapMonolishnone());
...
/*  mod.add_type<Parametric<TypeVar<1>, TypeVar<2>>>("BiCGSTAB")
     .apply<monolish::matrix::Dense<float>, float>(WrapMonolishBiCGSTAB<monolish::matrix::Dense<float>, float>())
     .apply<monolish::matrix::Dense<double>, double>(WrapMonolishBiCGSTAB<monolish::matrix::Dense<double>, double>());
     */
}